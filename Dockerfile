...
COPY xm_lines.py xm_web.py falcon_api.py salla_api.py wa_send.py crypto_store.py guide_pages.py store_sitemap.py xm_lines.html admin.html setup.html login.html index.html ./
COPY static ./static
