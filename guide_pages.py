...
PAGES = {
    ...
    "/samsung-lg": dict(
        ...
        desc="شرح تفعيل اشتراك IPTV على شاشات سامسونج و LG وكل شاشة تعمل بنظام WebOS، خطوة بخطوة عبر تطبيق 0Player المجاني، بلا رسيفر ولا جهاز إضافي.",
        h1="طريقة تثبيت اشتراك IPTV على شاشات سامسونج و LG وشاشات WebOS",
        intro="شاشات سامسونج و LG لا تقبل تطبيقات أندرويد، فلها تطبيق 0Player المجاني من متجر الشاشة. والخطوات نفسها تصلح لأي شاشة تعمل بنظام WebOS من علامة أخرى. اتبع الخطوات بالترتيب، ولا تحتاج رسيفر ولا أي جهاز إضافي.",
    ...
    "/windows": dict(
        ...
        desc="شرح تشغيل اشتراك IPTV على كمبيوتر ويندوز خطوة بخطوة عبر برنامج IPTV Smarters Pro أو برنامج IPTVnator المجاني، من التحميل حتى إدخال بيانات الاشتراك.",
        h1="طريقة تشغيل اشتراك IPTV على كمبيوتر ويندوز",
        intro="أمامك برنامجان على ويندوز: IPTV Smarters Pro بنسخته المكتبية، أو IPTVnator المجاني مفتوح المصدر بملف تثبيت واحد. اختر واحدًا واتبع خطواته.",
    ...
    "/carplay": dict(
        device="carplay",
        title="طريقة تشغيل IPTV على شاشة السيارة CarPlay | تطبيق rPlay TV | سمارت سوق",
        desc="شرح تشغيل اشتراك IPTV على شاشة السيارة عبر Apple CarPlay خطوة بخطوة بتطبيق rPlay TV المجاني من متجر آبل: تحميله على الآيفون، إدخال بيانات Xtream Codes، ثم فتحه من شاشة السيارة.",
        h1="طريقة تشغيل اشتراك IPTV على شاشة السيارة (CarPlay)",
        intro="لا تحتاج جهازًا إضافيًا في السيارة: التطبيق على الآيفون، والبيانات تُدخل مرة واحدة، ثم يظهر rPlay TV على شاشة السيارة كلما وصلت جوالك بها. وشاشة السيارة تشغّل قنوات البث المباشر فقط، أما الأفلام والمسلسلات فتشاهدها على الجوال أو على الشاشة بالاشتراك نفسه. اتبع الخطوات بالترتيب.",
        products=["p1205321184", "p1112367445"],
    ),
}
...
COMPARE_ROWS = [
    ...
    ("سيارة بنظام CarPlay", "عبر تطبيق rPlay TV على الآيفون",
     ["p254278482", "p1205321184"], "/carplay"),
