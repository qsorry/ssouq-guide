...
PAGES = {
    ...
    "/samsung-lg": dict(
        ...
        desc="شرح تفعيل اشتراك IPTV على شاشات سامسونج و LG وكل شاشة تعمل بنظام WebOS، خطوة بخطوة عبر تطبيق IPTV Smarters Pro من متجر الشاشة أو تطبيق 0Player المجاني، بلا رسيفر ولا جهاز إضافي.",
        h1="طريقة تثبيت اشتراك IPTV على شاشات سامسونج و LG وشاشات WebOS",
        intro="يمكن تشغيل الاشتراك على شاشات سامسونج و LG بأحد تطبيقين من متجر الشاشة: IPTV Smarters Pro أو 0Player. وقد لا يكون IPTV Smarters Pro متوافقًا مع بعض موديلات أو إصدارات سامسونج أو LG أو WebOS، فإن لم يظهر في متجر التطبيقات أو لم يعمل على جهازك فاستخدم 0Player، وهو بديل مجاني وفعّال. والخطوات نفسها تصلح لأي شاشة تعمل بنظام WebOS من علامة أخرى، ولا تحتاج رسيفر ولا أي جهاز إضافي.",
...
COMPARE_ROWS = [
    ("سامسونج أو LG", "باقة مخصّصة تُفعَّل عبر IPTV Smarters Pro أو 0Player من متجر الشاشة",
...
COMPARE_FAQ = [
    ...
    ("شاشتي سامسونج — أي باقة أشتري؟",
     "باقة شاشات سامسونج و LG حصرًا. الباقات الأخرى غير متوافقة مع نظام WebOS / Tizen، "
     "وتُفعَّل الباقة المخصصة على الشاشة مباشرة عبر تطبيق IPTV Smarters Pro أو 0Player من "
     "متجر الشاشة، بلا رسيفر ولا جهاز إضافي. وإن لم يظهر IPTV Smarters Pro في المتجر أو لم "
     "يعمل على موديلك، فتطبيق 0Player بديل مجاني وفعّال."),
