...
PAGES = {
    ...
    "/carplay": dict(
        ...
        intro="لا تحتاج جهازًا إضافيًا في السيارة: التطبيق على الآيفون، والبيانات تُدخل مرة واحدة، ثم يظهر rPlay TV على شاشة السيارة كلما وصلت جوالك بها. اتبع الخطوات بالترتيب.",
        products=["p1205321184", "p1112367445"],
    ),
}
